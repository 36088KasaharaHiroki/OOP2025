...
namespace Exercise02 {
    ...
    new Book { Title = "楽しいC#プログラミング教室", Price = 2540, Pages = 348 },
        ...
        private static void Exercise3(List<Book> books) {
            var book = books.Where(b => b.Title.Contains("C#")).Average(x => x.Pages);
            Console.WriteLine(book);
        }
        ...
        private static void Exercise5(List<Book> books) {
            var book = books.Where(b => b.Price < 4000).Max(x => x.Pages);
            Console.WriteLine(book);
        }

        private static void Exercise6(List<Book> books) {
            var book = books.Where(b => b.Pages >= 400).OrderByDescending(x => x.Price);
        ...
        private static void Exercise7(List<Book> books) {
            var book = books.Where(b => b.Title.Contains("C#")).Where(x => x.Pages <= 500);
            foreach (var item in book) {
